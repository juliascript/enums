...
func getWeekdayName(weekday: Weekday) -> String{
    ...
    switch weekday{
    case .sunday:
        weekdayString = Weekday.sunday.rawValue
    case .monday:
        weekdayString = Weekday.monday.rawValue
    case .tuesday:
    ...
    case .friday:
        weekdayString = Weekday.friday.rawValue
    case .saturday:
        weekdayString = Weekday.saturday.rawValue
    }
    
    return "This weekday is called \(weekdayString)."
}

func isItFinallyWeekend(weekday: Weekday) -> String{
    let weekdayName = getWeekdayName(weekday: weekday)
    switch weekday{
    case .monday, .tuesday, .wednesday, .thursday, .friday:
        return "\(weekdayName) is a regular workday."
    case .saturday:
        return "Wuhuuuu, it's SATURDAYYYYYYYY."
    case .sunday:
        return "Wuhuuuu, it's SUNDAYYYYYYYY."
    }
}
